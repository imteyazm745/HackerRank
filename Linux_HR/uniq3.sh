...
#solution
uniq -c -i| cut -c7- #here cut -c7- will cut the 7 spaces from every line

<<COMMENTS

uniq -c -i #[here -i is present which means AA, Aa are the same as 'aa]
      2 00
      2 01
      2 00
      2 02
...
uniq -c #[here i is not present which means AA, Aa are not same as 'aa]
